    ...
    <div class=" vanbox m-l-10" v-if="value==''">
        <div>
            ...
            <div>
                ...
                <div v-if="setPosition_city!==''" class="currentcity m-l-10 m-t-20 ccc">{{setPosition_city}}</div>
                <div v-if="setPosition_city===''" class="currentcity m-l-10 m-t-20 ccc">定位中..</div>
