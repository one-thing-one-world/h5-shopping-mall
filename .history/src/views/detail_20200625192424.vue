    ...
    <div class="box ">
        ...
        <div class="bottom_nav">
            ...
            <div>
                ...
                <van-popup closeable close-icon="close" v-model="show" position="bottom" :style="{ height: '30%' }">

                    <div class="df" v-if="obj">

                    

                        <div v-if="obj">
                        
                            <div class="pic_box"><img class="pic b1" :src="obj.image" alt=""></div>
                        </div>
                        
                        <div>
                            <div>{{obj.name}}</div>
                            <div>￥{{obj.orl_price}}</div>
                        </div>
                    </div>
                </van-popup>
