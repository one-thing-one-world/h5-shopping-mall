...
<div>
    <div>
        ...
        <div class="content_box  j-center" v-if="oneItem">
            <div class="contents r1">{{oneItem.content}}</div>
        </div>

        <div class="pic_box j-center" v-if="oneItem">
            ...
            <div class="pic_box_container df a-center">
                ...
                <div class="pic_text m-l-">
                    {{ oneItem.goods[0].name}}
                </div>

                <div>
                    <div class="cart ccc b1"><van-icon name="cart" /></div>
                </div>
            </div>
