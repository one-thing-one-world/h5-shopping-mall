    ...
    <div>
        ...
        <div class="text_box ">
            ...
            <div class=" bottom df a-center j-center f-column">
                <div class="save ccc" @click="save">保存</div>
...
export default {
    ...
    methods: {
        save() {
            ...
            // this.$api.getSaveUser()(this.gender, this.year, this.month, this.day, this.nickname, this.userId).then(res => {
            ...
            localStorage.setItem('personList', JSON.stringify(oneObj))
            console.log(localStorage.getItem('personList', JSON.stringify(oneObj)));
            this.$router.push({name"mi})
