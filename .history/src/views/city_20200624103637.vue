    ...
    <div class=" vanbox m-l-10" v-if="value==''">
        <div>
            ...
            <div>
                ...
                <div v-if="position_city!==''" @click="gotohome(this.position_city)" class="currentcity m-l-10 m-t-20 ccc">{{position_city}}</div>
                <div v-else-if="position_city===''" class="currentcity m-l-10 m-t-20 ccc">{{citysss}}</div>
            ...
            <div>
                ...
                <div class="hotbox  ">
                    <div class="hotcity" v-for="(item,index) in four" :key="index">
                        <div @click="gotohome(item.name)" class="hot_item ccc">{{item.name}}</div>
                    </div>
                </div>
            </div>
        ...
        <van-index-bar>
            <div v-for="(item,index) in two" :key="index">
                ...
                <div @click="gotohome(item1.name)" v-for="(item1,index1) in three[index]" :key="index1">
...
export default {
    ...
    methods: {
        ...
        gotohome(a) {
            ...
            console.log(this.position_city);
            this.$router.push({
                name: 'home',
