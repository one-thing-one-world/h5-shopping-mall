                ...
                <div class="b1  loop_item_box df f-column a-center">
                    ...
                    <div class="loop_item y1" v-for="(item,index) in list" :key="index">
                        ...
                        <div class="all m-t-15">
                            <van-card :num="item.order_list[0].count" :price="item.mallPrice" :title="item.order_list[0].name"  thumb="https://img.yzcdn.cn/vant/ipad.jpeg" />
                        </div>
                        <div class="line_box m-b-10 j-center">image_path
                            <div class="line"></div>
                        </div>
