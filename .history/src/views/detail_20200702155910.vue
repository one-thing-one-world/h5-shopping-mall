    ...
    methods: {
        ...
        collect() {
            this.$api.getCollection(this.obj).then(res => {
                this.$api.getIsCollection(this.obj.id).then(res => {
                    this.flagss = res.isCollection
                    localStorage.setItem('flags',this.flagss)
                    console.log(res);
                }).catch(err => {
                    console.log(err);
                })
        ...
        canccelCollect() {
            this.$api.getCancelCollection(this.obj.id).then(res => {
                ...
                this.$api.getIsCollection(this.obj.id).then(res => {
                    this.flagss = 0
                    localStorage.setItem('flagss',this.flagss)
                    console.log(res);
                }).catch(err => {
                    console.log(err);
                })
