...
export default {
    ...
    methods: {
        ...
        gotocomments() {
            ...
            this.comments = JSON.parse(localStorage.getItem('views'))
            
            console.log(this.comments)
            
            this.comments.map((item,index)=>{
                this.$api.getGoodsOne(item).then()
            })
        ...
        getSomeItem() {
            this.id = this.$route.query.id
            let one = localStorage.getItem('arraydatas');
            console.log(one);

            let a = JSON.parse(one)
            console.log(a instanceof Array);
            console.log(a);
            a.push(this.id)
            console.log(a);
            localStorage.setItem('arraydatas', a)
            
            console.log(localStorage.getItem('arraydatas'))

            // localStorage.setItem('arraydata', arr)
