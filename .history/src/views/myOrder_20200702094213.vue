    ...
    <div>
        <van-tabs v-model="active" @click="onClick">
            ...
            <van-tab title="已完成" class="j-center">
                ...
                <div class="b1  loop_item_box df f-column a-center">

                    <div class="loop_item y1" v-for="(item,index) in list" :key="index">
                        ...
                        <div class="all m-t-15">
                            <van-card :num="item.order_list[0].count" :price="item.mallPrice" :title="item.order_list[0].name"  :thumb="item.order_list[0].image_path" />
                        </div>
                        ...
                        <div class="df fs14 f-column ">
                            ...
                            <div>共件商品 合计:{{item.order_list[0].count*item.mallPrice}}:00元</div>
