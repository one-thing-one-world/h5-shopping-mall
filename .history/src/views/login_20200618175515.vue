            ...
            <div class=" m-t-20 ">
                <van-form @submit="onSubmit">
                    ...
                    <div class="sub j-around  df">
                        <van-button class="wb30" round block type="primary" native-type="submit" @click="gologin" >
                            登录
                        </van-button>
                        <van-button class="wb30" round block type="warning" native-type="submit" @click="gologin" >
                            注册
                        </van-button>
                    </div>
                </van-form>
