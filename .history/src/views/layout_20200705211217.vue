    ...
    <div class="container" ref="container">
        <div class="box">
            ...
            <div class="bottomnav r1  fs14 df">
                ...
                <div :class="{'one':this.flag===2}" class="catalayout f1 f1 df a-center j-center f-column" @click="gotoCata">
                    <div class="fs25">
...
export default {
    ...
    methods: {
        ...
        setData() {
            ...
            localStorage.setItem('arraydatas', arrString)
    ...
    computed: {
        addNumber() {
            return this.$store.state.addNumber
        }
