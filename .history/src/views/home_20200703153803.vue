...
<div>
    ...
    <div class="search_container r1" v-if="searchData.length>0">
        <div class="swapFruit" ref="swapFruit">
            <div class="content">
                <div class=" df j-center" v-for="(item,index) in searchData2" :key="index">

                    <div class="search_box df a-center  h40">{{item.name}}</div>
...
原文链接：https://blog.csdn.net/zhouzuoluo/java/article/details/84752280
