    ...
    <div class="box ">
        ...
        <div v-else>
            ...
            <div class="content_box ">
                <div class="df m-t-15 content_box1  j-bettween">

                    <div class=" picture" v-if="contents"><img src="../assets/ssw.jpg" alt=""></div>
                    <div>
                        <div v-if="contents.anonymous === false">{{contents.user[0].nickname}}</div>
                        <div v-if="contents.anonymous === true">匿名人士</div>
                        <div>
                            <div v-if="contents"  class="df fs14 star">
                                <van-rate v-model="contents.rate" :count="5" />
                            </div>
                        </div>
                    </div>
                    <div  v-if="contents" class="ccc">时间:{{contents.comment_time}}</div>
                </div>
                <div class="content_box2 m-l-10 m-t-15">
                    <div v-if="contents">评论：{{contents.content}}</div>
                </div>
            </div>
