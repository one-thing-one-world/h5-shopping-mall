...
<div>
    ...
    <div>
        <van-address-list v-model="chosenAddressId" :list="list" :disabled-list="list" disabled-text="以下地址超出配送范围" default-tag-text="默认" @add="onAdd" @edit="onEdit" @select="select" />
    </div>
</div>
</template>
