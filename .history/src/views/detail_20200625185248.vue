    ...
    <div class="box ">
        ...
        <div class="bottom_nav">
            <van-goods-action>
                ...
                <van-goods-action-button type="danger" text="立即购买" round=false @click="show = true" />
                <van-action-sheet v-model="show" round=false>

                    <div class="df" v-if="obj">
                        
                        <div class="canc ccc "><van-icon name="cross" /></div>

                        <div><img class="w90" :src="obj.image" alt=""></div>
                        <div>
                            <div>{{obj.name}}</div>
