    ...
    <div class="box">
        ...
        <div class="container">
            ...
            <div class="h60 ccc">
                ...
                <div @click="goToAdress" class="underline_box ccc">点击添加收货地址
        ...
        <div class="bottom  df j-end">
            ...
            <div class="bottom_left ccc  df">
                ...
                <div v-if="!id" class="colorRed">￥<span class="allPrice">{{totalPrice}}</span>:00</div>
