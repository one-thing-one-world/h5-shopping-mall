            ...
            <div class="h60 h60box ccc">
                <div v-if="defaultAdress">
                    ...
                    <div class="people df j-bettween">
                        ...
                        <div class="m-r-10 ccc">{{defaultAdress.tel}}</div>
                    </div>
                    <div class="goodsAress">
                        收货地址:{{defaultAdress.address}} {{defaultAdress.addressDetail}}
                    </div>
                    <div @click='chooseAdress' class="chooseAdress ccc">
                        <van-icon name="arrow" />
                    </div>
