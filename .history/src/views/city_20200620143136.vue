    ...
    <div class="top_fixed">
        ...
        <div class="box_top">
            ...
            <div v-if="value!==''">
                    ...
                    <div @click="gotohome(item.name)" class="item_city" v-for="(item,index) in caicai" :key="index">
    ...
    <div class=" vanbox m-l-10" v-if="value==''">
        <div>
            ...
            <div>
                ...
                <div v-if="citysss!==''" class="currentcity m-l-10 m-t-20 ccc">{{citysss}}</div>
                <div v-if="citysss===''" class="currentcity m-l-10 m-t-20 ccc">定位中..</div>
