...
export default {
    ...
    methods: {
        ...
        submitOrder() {
            ...
            // getOrder(this.defaultAdress.address, this.defaultAdress.tel, arr, totalPrice1, false, count) {
            ...
            if (this.defaultAdress) {
                ...
                if (!this.id) {
                    ...
                    // getOrder(this.defaultAdress.address, this.defaultAdress.tel, arr, totalPrice1, false, counts) {
                    //         return service.post('/order', {
                    //             address: address,
                    //             tel: tel,
                    //             orderId: orderId,
                    ...
                    let arr = [];
                    arr.push(this.id)
                     this.$api.getOrder(this.defaultAdress.address, this.defaultAdress.tel, arr, this.totalPrice1, true, this.value).then(res => {
                        console.log(res);
                    }).catch(err => {
                        console.log(err);
                    })
