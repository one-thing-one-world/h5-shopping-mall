    ...
    <div class="box ">
        ...
        <div class="bottom_nav">
            <van-goods-action>
                ...
                <van-goods-action-icon icon="cart-o" badge="2" text="购物车" />
            ...
            <div>
                ...
                <van-popup closeable close-icon="close" close-icon-position="top-right" v-model="show" position="bottom" :style="{ height: '30%' }">
                    ...
                    <div class="pic_container m-t-20   df" v-if="obj">
                        ...
                        <div>
                            <div class=" m-t-15 m-l-20 fs14">{{obj.name}}</div>
                            <div class=" m-t-4 pop_price fs14 m-l-20">￥{{obj.orl_price}}</div>
                        </div>

                    </div>

                    <div class="b1 fs14  p-b-10 buy_count">

                        <div class="m-t-10 m-l-10">购买数量</div>
                        <div class="df j-bettween">
                            <div class="df  m-t-7 m-l-10">
                                <div>
                                    <div class="shengyu">剩余{{}}件</div>
                                </div>
                                <div>
