...
<div>
    ...
    <div class="b1 comment_box">
        <div v-if="flag===0" class="j-center f-column">

            <div class="df r1 pic_under_box " v-for="(item,index) in list" :key="index">
                <div class="pic">
                ...
                <div class="df f-column j-around ">
                    ...
                    <div class=" j-end">
                        <div class="comments_pic  ccc">评价晒图</div>
                    </div>
