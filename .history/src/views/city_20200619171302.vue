...
<div class="box">
    ...
    <div>
        ...
        <div>
            <div>当前城市</div>
            <div v-if="position_city!==''" class="currentcity m-l-10 m-t-10 ccc">{{position_city}}</div>
            <div v-if="position_city ===''" class="currentcity m-l-10 m-t-10 ccc">定位中</div>
        </div>
        <!-- <div>
...
position_city(){
            ...
            setTimeout(()=>{
                  this.num = true this.$store.state.position_city
            },10000)
