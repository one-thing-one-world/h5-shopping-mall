    ...
    <div class="comment_box">
        <div v-if="flag===0" class="a-center f-column">
            ...
            <div class="df  pic_under_box " v-for="(item,index) in list" :key="index">
                ...
                <div class="df w262 f-column j-around ">
                    <div class=" h44">
                        {{item.name}}
                    </div>
            ...
            <div v-if="list.length===0">
                <div class="ccc">暂无数据</div>
                <div class="ccc m-t-10">下面没有内容了</div>
            </div>
        ...
        <div v-if="flag===1" class="a-center f-column">
            ...
            <div class="df  pic_under_box " v-for="(item,index) in list2" :key="index">
                ...
                <div class="df w262 b1 f-column j-around ">
                    <div class=" h44">
                        {{item.goods[0].name}}
                    </div>

                    <div class=" j-end ">
                        <div @click="goToComment2(item,index)" class="comments_pic look ccc">查看评价</div>
                    </div>
