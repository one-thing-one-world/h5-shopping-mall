...
<div>
    <div>
        ...
        <div class="df m-t-20">
            ...
            <div class="time ccc">
                <div>{{this.oneItem.comment_time}}</div>
            </div>
        </div>

        <div class=" m-t-20 ccc">
            <div class="contents">{{this.oneItem.content}}</div>
        </div>

        <div>
            <div v-if="this.oneItem.length>0">
                <div class="pic"><img :src="this.oneItem.goods[0].image_path" alt=""></div>
            </div>
        </div>
