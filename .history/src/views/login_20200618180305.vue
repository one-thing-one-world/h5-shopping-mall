            ...
            <div class=" m-t-20 ">
                <van-form @submit="onSubmit">
                    ...
                    <div class="sub j-around  df">
                        <van-button class="wb30" round block type="primary" native-type="submit" @click="login(name,password,verifyCode)" >
                            登录
                        </van-button>
                        <van-button class="wb30" round block type="warning" native-type="submit" @click="registerAndLogin(name,password,verifyCode)" >
                            注册
                        </van-button>
                    </div>
                </van-form>
...
export default {
    ...
    methods: {
        login(name,password,verifyCode){
            this.$api.getLogin(name,password,verifyCode).then(res=>{
                console.log(res);
        ...
        registerAndLogin(name,password,verifyCode){
            this
        },
        register(){
            this.$router.push({name:'mine'})
