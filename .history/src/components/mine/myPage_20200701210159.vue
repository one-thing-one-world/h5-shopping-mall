...
<div>
    ...
    <div class="box1">
        ...
        <div class="df">
            <div class="f1  item" @click="gotoSomePage1(item,index)" v-for="(item,index) in list1" :key="index">
                <div>
    ...
    <div class="box2">
        ...
        <div @click="goSomePage2(item,index)" class="box2_container"  v-for="(item,index) in list2" :key="index">
