...
<div>
    ...
    <div class="box1">
        ...
        <div class="df">
            <div class="f1 b item" @click="gotoSomePage(item,index)" v-for="(item,index) in list1" :key="index">
                <div>
                ...
                <div class="ccc b1 comments_num" v-if="index===3">
                    <div v-if="list.length>0">{{list.length}}</div>
                </div>
