...
<div>
    ...
    <div class="box1">
        ...
        <div class="df">
            <div class="f1  item" v-for="(item,index) in list1" :key="index">
                <div>
    ...
    <div class="box2">
        ...
        <div class="box2_container" @click="gotoSomePage(item,index)" v-for="(item,index) in list2" :key="index">
