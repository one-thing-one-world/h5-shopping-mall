        ...
        <div class="box df ">
            <div class=" fs14 b-r-1-g" v-for="(item,index) in recommend" :key="index">
                ...
                <div class="df a-center j-center ">
                    <div class="df">
                        <div @click='addShop(item.goodsId)' class="w20  ccc p5 ">
                            <van-icon name="cart" />
                        </div>
    ...
    methods: {
        addShop(goodsId) {
            if (this.users) {
                ...
                this.$api.getAddshopping(goodsId).then(res => {

                    console.log(res);
                   
                            this.$api.getCard().then(res => {
                                this.shopList = res.shopList
                                this.addNumber =   _this.$store.commit('setPosition_city', _this.citysss)
                        ...
                        //   this.addNumber =  this.$route.params.cityname
