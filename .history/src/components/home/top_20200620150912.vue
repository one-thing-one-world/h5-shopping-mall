    ...
    <div>
        <div class="top df">
            ...
            <div class="top_left  f1  df">
                ...
                <div @click="gotocity" v-if="city!=''" class="top_left_left f15 df f-column j-center t-r">
                    {{city}}
                </div>
                <div v-if="(city=='')&&(cityname=='')" class="top_left_left f15 df   f-column j-center t-r "> 定位中.</div>
