...
<div>
                ...
                <div class="right_content df" v-if="somedata.length>0">

                    <div class="right_item" v-for="(item,index) in somedata[aIndex].bxMallSubDto" :key="index">
                        <div>{{item.mallSubName}}</div>
                    </div>
