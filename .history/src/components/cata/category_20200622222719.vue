...
<div>
    ...
    <div class="df">
        ...
        <div class="left" v-if="somedata.length>0">
            <div class="left_text b1" :class="{'left_texts':index===flag1}" @click="selectTitle(item,index)" v-for="(item,index) in somedata" :key="index">
                <div class="b1 w75 ccc"  :class="{'left_textss':index===flag1}">
