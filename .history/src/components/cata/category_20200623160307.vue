                            ...
                            <div v-for="(item1,index1) in arr" :key="index1">
                                ...
                                <div class="df b1">
                                    ...
                                    <div class="m-l-10">
                                        ...
                                        <img class="w75 g1" :src="arr[index1].image" alt="">
                                    
                                    </div>

                                    <div>
                                            <div class=" b1 m-l-10 cred  m-t-10">{{item1.name}}</div>
                                            
                                            <div class=" b1 m-l-10 m-t-10">
                                            
                                                <span class="text1 cred">{{item1.present_price}}</span><span class="text2">{{item1.orl_price}}</span>
