        ...
        <div v-else>
            ...
            <van-checkbox-group v-model="result" ref="checkboxGroup">
                <div class="df j-bettween ">
                    ...
                    <div class="choose_right b1">

                        <div class="sum b1">合计:<span class="sum_price">￥0:00</span></div>
                ...
                <div class="df r1 a-center   delet j-end">

                    <div class="b1 ccc delet1">删除</div>
                    <div class="b1 ccc delet2">去结算</div>
...
.item_item{
    ...
    border-top: 1px solid rgb(218, 205, 205);
    padding:8px 0px;
