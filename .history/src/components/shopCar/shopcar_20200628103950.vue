    ...
    <div v-else-if="users">
        ...
        <div v-else>
            ...
            <van-checkbox-group v-model="result" ref="checkboxGroup">
                <div class="df j-bettween ">
                    ...
                    <div class="choose_left ccc">
                        ...
                        <div class="selectall ">
                            ...
                            <van-checkbox @click="checkAll" v-model="flag" name="a">全选</van-checkbox>
                    ...
                    <div class="choose_right ">
                        ...
                        <div class="sum ">合计:<span class="sum_price">￥0:00</span></div>
                ...
                <div v-if="true" class="df   a-center   delet j-end">

                    <div class=" ccc  delet1" @click="del">删除</div>
                    <div class=" ccc  delet2" @click="gotoSettlement">去结算</div>
                        ...
                        <div v-for="(item, index) in shopList" class="df item_item" :key="index">
                            ...
                            <div class=" circle ccc">
                                <van-cell clickable @click="toggle(index)">
                                    ...
                                    <template #right-icon>
                                        <van-checkbox :name="item" v-model="item.check" ref="checkboxes" />
                                    </template>
...
export default {
    ...
    methods: {
        ...
        toggle(index) {
            ...
            this.flag = this.shopList.some((item, index) => {
                return item.check === fale
            })
