        ...
        <div v-else>
            ...
            <div class="df j-bettween ">
                <div class="choose_left ccc">
                    <div class=""><van-button type="primary" @click="checkAll">全选</van-button></div>
                </div>
            ...
            <div class="b1">
                ...
                <van-checkbox-group v-model="result" ref="checkboxGroup">
                    ...
                    <van-cell-group>
                        ...
                        <van-cell v-for="(item, index) in shopList" clickable :key="item" :title="`复选框 ${item}`" @click="toggle(index)">
